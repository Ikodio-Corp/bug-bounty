      ...
      <div className="lg:ml-64 min-h-screen">
        <div className="relative z-10 p-10">
          ...
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6 mb-8">
            ...
            <code className="block p-3 bg-black/30 rounded-lg text-gray-400 font-mono">https://api.ikodio.com/v1</code>
          </div>
              ...
              {endpoints.map((ep, idx) => (
                <div key={idx} className="p-4 bg-white/5 rounded-lg">
                  <div className="flex items-center gap-4 mb-2">
                    <span className={`px-3 py-1 rounded text-xs font-bold ${ep.method === 'GET' ? 'bg-green-600/20 text-green-400' : 'bg-white/20 text-gray-400'}`}>{ep.method}</span>
