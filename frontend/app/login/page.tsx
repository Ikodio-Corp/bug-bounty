...
import { Mail, Lock, Eye, EyeOff, Github, Chrome, Shield, Sparkles, ArrowRight, AlertCircle, Key, CheckCircle2 } from 'lucide-react';
    ...
    <div className="h-screen bg-black text-white flex overflow-hidden">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-black relative overflow-y-auto">
        ...
        >
          <div className="mb-6">
            ...
            <h1 className="text-3xl font-bold mb-2">Sign in to IKODIO</h1>
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-gray-900 via-black to-gray-900">
        ...
        {[
          ...
          { color: 'from-gray-600/50 to-gray-700/40', size: 'w-72 h-72', blur: 'blur-3xl', x: '72%', y: '28%', duration: 16, path: [0, 41, -36, 0] },
        ].map((orb, i) => (
          <motion.div
            key={i}
